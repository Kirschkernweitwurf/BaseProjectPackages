...
namespace Base.AttributePackage.Editor
{
    ...
    public sealed class TitleHandler : IBeforeFieldHandler
    {
        ...
        public void BeforeField(in MemberContext context)
        {
            ...
            bool hasColor = ColorAttributeUtility.TryResolve(attribute.ColorHex, attribute.PresetColor, out Color color);
            ...
            lineRect.height = 1f;
            EditorGUI.DrawRect(lineRect, hasColor ? color : new Color(0.5f, 0.5f, 0.5f, 0.5f));
